...
def upload_to_s3_and_queue(file):
    try:
        ...
        return {"status": "success", "message": "File uploaded", "file_key": file_key}
...
def main():
    ...
    st.subheader("Paddle powered Lambda Function")

    # Section 1: File Uploading
    st.subheader("1. Upload Files")
    uploaded_files = st.file_uploader("Choose files", type=["pdf", "docx", "csv", "doc", "png", "jpg", "jpeg", "xlsx", "tsv"], accept_multiple_files=True)
